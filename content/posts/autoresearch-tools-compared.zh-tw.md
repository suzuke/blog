...
四個測試都在 Claude Code Max 底下用 Claude Opus 4.6 跑。同樣的模型、同樣的訂閱，推理能力沒有差異。唯一的變數是工具架構和 agent 能看到什麼。完整結果、程式碼和 prompt 都在 [benchmark repo](https://github.com/suzuke/autoresearch-benchmark)。
